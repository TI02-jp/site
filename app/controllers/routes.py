...
@login_required
def videos():
    """Display the curated library of training videos."""

    drive_embed_url = (
        "https://drive.google.com/embeddedfolderview?id="
        "1DJHoZjMX88LaZQr1T_bi50oQB_BIg97a#grid"
    )
    return render_template("videos.html", drive_embed_url=drive_embed_url)
